...
最新版本v1.1.5 可在releases页面下载 
https://github.com/zhuchao941/canal2sql/releases/tag/v1.1.5
...
- -C, --clean    纯净模式，只输出SQL语句和耗时，适用于直接捞出SQL回滚的场景（可结合`tac`命令或者`tail -r`倒序输出）（v1.1.5版本新增）
